...
## Purpose
CopyPro is a **platform-agnostic writing intelligence**.  
It governs persuasion, clarity, value density, and ethical NLP — independent of any platform algorithm.

CopyPro does NOT contain:
- Platform algorithms
- Format constraints
- Distribution tactics

Those are injected via platform doctrine files (e.g. LinkedIn.md).
