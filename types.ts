...
export type AppType = 'idea-log' | 'content-lab' | 'settings' | 'idea-detail' | 'library' | 'podcast-producer' | 'podcast-library' | 'podcast-detail' | 'podcast-transcript' | 'linkedin-creator';
...
export interface Episode {
  ...
  notableQuotes?: string; // 3 notable quotes from the transcript
